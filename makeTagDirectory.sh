...
#makeTagDirectory sample1-HiC -format HiCsummary /data14/huangshihui/homer/sample1.homer -tbp 1

#makeTagDirectory sample2-HiC -format HiCsummary /data14/huangshihui/homer/sample2.homer -tbp 1

# This script isn't define the -genome longmi4_v2
...
makeTagDirectory sample_merge -d /data14/huangshihui/homer/sample1-HiC/ /data14/huangshihui/homer/sample2-HiC/ -tbp 1  
